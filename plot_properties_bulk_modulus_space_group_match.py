...
all_bulk_moduli = extract_bulk_moduli_from_dirs(directories, filename="properties_space_group.txt")
...
# Save and show
plt.savefig("bulk_modulus_distribution_vs_i_space_group.png", dpi=300, bbox_inches="tight")
plt.show()
