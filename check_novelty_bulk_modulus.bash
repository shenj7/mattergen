...
mattergen-generate $RESULTS_PATH --pretrained-name=$MODEL_NAME --batch_size=100 --properties_to_condition_on="{'ml_bulk_modulus': 400}" --diffusion_guidance_factor=2.0
